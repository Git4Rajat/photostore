// Photostore — one-click deployment template.
//
// Provisions everything needed to run Photostore in your own Azure
// subscription, pulling PUBLIC prebuilt container images from GitHub Container
// Registry (ghcr.io). No build step, no private registry, no CLI required —
// this is what the "Deploy to Azure" button uses.
//
// Deploys (into the resource group you choose):
