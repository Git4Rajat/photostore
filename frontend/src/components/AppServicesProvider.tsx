...
// to "Processing photos finished" and clearing the notification the instant
        ...
        try {
            ...
            const processOnePendingItem = async (
                ...
                try {
                    ...
                    const wasFreshlyUploaded = freshlyUploadedFilenamesRef.current.delete(filename);
                    // See shouldSkipConvertedRawPreview: confirmed live making Tools > Force
                    // re-run a permanent no-op for RAW files (IMG_9206.DNG/IMG_9209.DNG, 2026-09-15).
            ...
            const worker = async () => {
                while (true) {
                    ...
                    try {
                        ...
                        if (uploadStopRequestedRef.current || isUploadStoppedError(err)) {
                            throw new Error(UPLOAD_STOPPED_ERROR, { cause: err });
                        }
