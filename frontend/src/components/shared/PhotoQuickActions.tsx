...
export const WORKBENCH_URL_FILENAME_CAP = 50;
export const workbenchFilenamesHref = (filenames: string[]): string =>
    `/tools/browser-workbench?filenames=${filenames.map((f) => encodeURIComponent(f)).join(',')}`;
